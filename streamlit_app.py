...
marriage_years = st.number_input('Years of Marriage(Note: If not married please enter "0"):', min_value=0, step=1)
...
if st.button("Predict"):
    ...
    if prediction[0] == 1:
        st.success("The user might have PCOS.")
    else:
        st.success("The user does not have PCOS.")
